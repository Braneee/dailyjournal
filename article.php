<div class="container">
    ...
    <button type="button" class="btn btn-secondary mb-2" data-bs-toggle="modal" data-bs-target="#modalTambah" data-bs-toggle="#IdModal">
        <i class="bi bi-plus-lg"></i> Tambah Article</button>
    <div class="row">
